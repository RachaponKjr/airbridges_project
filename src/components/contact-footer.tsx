    ...
    return (
        <div className='py-12 flex flex-col px-5 lg:px-0 lg:flex-row gap-11 lg:gap-24 container mx-auto'>
            <div className='text-white w-full lg:max-w-[600px] space-y-3 text-center lg:text-start'>
                ...
                <p className='text-white/80 text-sm lg:text-2xl font-normal'>If you haven't seen exactly what you want or there is something we haven't covered - don't hesitate to get in touch with us. We're here to answer any questions you may have about our Consultancy services.</p>
            </div>
