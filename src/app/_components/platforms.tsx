    ...
    const platformsData = [
        {
            ...
            description: 'Automation Consultants is an AWS Select partner. With a large team of qualified AWS Solution Architects and specialty AWS experts, Automation Consultants can help you migrate workloads to AWS, design and optimise them in AWS and create automated DevOps solutions in AWS.',
        },
        {
            id: 2,
            name: 'Microsoft Azure',
            description: 'Automation Consultants is a Microsoft Gold Partner. Our team of Azure experts can help you migrate workloads to Azure, design and optimise them in Azure and create automated DevOps solutions in Azure.',
        },
        {
            id: 3,
            name: 'Google Cloud Platform',
            description: 'Automation Consultants is a Google Cloud Partner. Our team of Google Cloud experts can help you migrate workloads to GCP, design and optimise them in GCP and create automated DevOps solutions in GCP.',
        },
        {
            id: 4,
            name: 'Huawei Cloud',
            description: 'Automation Consultants is a Huawei Cloud Partner. Our team of Huawei Cloud experts can help you migrate workloads to Huawei Cloud, design and optimise them in Huawei Cloud and create automated DevOps solutions in Huawei Cloud.',
        },
    ]
