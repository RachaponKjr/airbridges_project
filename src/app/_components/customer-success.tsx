...
function CustomerSuccess() {
    ...
    return (
        <section className="bg-[radial-gradient(circle_800px_at_bottom,#003094_0%,#003094_24%,#020816_100%)] 
                ...
                <div className='lg:mb-14 mt-8 lg:my-14 space-y-8 lg:space-y-10'>
                    ...
                    <div className='space-y-4 lg:space-y-10 mb-14 lg:mb-0'>
                        <Swiper
                            ...
                            spaceBetween={0}
                            loop={true}
                            pagination={{ clickable: true, el: '.swiper-pagination', type: 'bullets', dynamicBullets: true, dynamicMainBullets: 1 }}
                            navigation={{
                                prevEl: '.button-prev',
                                nextEl: '.button-next',
                            }}
                        ...
                        >
                            <SwiperSlide>
                                <div className='lg:py-6 text-sm lg:text-[26px] text-center text-white lg:px-[187px]'>
                                    <p>
                                        Automation Consultants provide us with an extra "confidence layer" when we're performing major work or tasks that are not carried out routinely.
                                        We're able to tap into their expertise and experience with various software solutions and ways of working that we may not have considered.
                                    </p>
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className='lg:py-6 text-sm lg:text-[26px] text-center text-white lg:px-[187px]'>
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima voluptatem dolorem, distinctio fugit quisquam vero.</p>
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className='lg:py-6 text-sm lg:text-[26px] text-center text-white lg:px-[187px]'>
                                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Iure explicabo reprehenderit doloremque saepe earum expedita minima totam neque ut odio?</p>
                                </div>
                            </SwiperSlide>
                        </Swiper>
