      ...
      >
        <div className="w-[965px] max-w-full text-center text-white space-y-2">
          ...
          <p className="text-sm lg:text-2xl">
            AC has considerable experience in helping companies reap the benefits of the Cloud, both on a small and
            large scale. Get in touch with us today to find out how our cloud consulting services can transform your
