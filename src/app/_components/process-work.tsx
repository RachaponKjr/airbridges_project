...
const workProcess = [
    ...
    },
    {
        image: fund,
        title: 'Fund',
        description: 'Review whether incentive schemes are available to subsidize your costs. Forecast operating costs in the cloud.',
    },
    {
        image: deliver,
        title: 'Deliver',
...
function ProcessWork() {
    return (
        <section className='bg-[#020816] w-full h-max px-4 py-16 lg:py-32 flex flex-col gap-10 lg:gap-20'>
            <div className='max-w-[1024px] mx-auto text-center text-white space-y-4'>
                ...
                <p className='text-sm lg:text-2xl leading-loose'>
                    No matter what cloud service you’re looking for – whether it’s CloudStart, CloudShift, or CloudPace – AC uses its proven Cloud model to maximize the success of your journey in the cloud.
                </p>
            </div>
